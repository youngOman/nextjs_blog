...
const About = () => {
  ...
  return (
    <div id='about' className='md:h-screen p-2 flex items-center py-16 px-10 font-serif font-semibold'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2 text-base md:text-lg'>
          ...
          當然我也早已有心裡準備，很早就開始強迫自己習慣一整天坐在電腦前凌遲我的腦袋，但...這領域強中自有強中手，我的實力還是遠遠不足是個無可否認的事實
          </ReadMore>
          <p className='py-4'>
          ...
          <p className='py-2'>
            ...
            乃至主機架設跟伺服器部署都自己做，<span className='text-2xl font-bold text-indigo-600'>沒錯！我全都要！</span>，每個部份要理解跟學"會"是真的需要犧牲非常大量的時間，
            ...
            &ensp;，當然我絕對不敢說自己樣樣都精通，和大多數人一樣我也還在不斷學習中，也是到後來才開始熟悉
            <span className='font-serif	'>"Architecture Patterns","Design Patterns","Idioms"...等，才逐漸建構出一個完整的概念，</span>
            很早之前還自己跟自己在3台不同裝置版控XD<span className='text-gray-500 text-sm'>{`(`}還跟自己衝突很多次....{`)`}</span>，最終目的都是為了習慣開發龐大專案的情境
          </p>
