    ...
    <div id='about' className='md:w-full md:h-screen p-2 flex items-center py-16 font-serif font-semibold text-xl'>
      <div className=' md:max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <ReadMore sliceNums={33} str="終於怎樣?!">
            五專時期在文學院待了五年，不斷精進自己直到畢業那刻終於!!!...認知到我的軟體工程師之路勢必會走的比別人還要艱辛許多....
          </ReadMore>
          <ReadMore sliceNums={87} str="又怎樣?#!@(">
          一個從裡到外都是標準文科生的人跳到資訊領域，在之後付出的代價絕對是我當時想像不到的，
          當然我也早已有心裡準備，很早就開始強迫自己習慣一整天坐在電腦前凌遲我的腦袋，但其實...這領域強中自有強中手，我的實力還是遠遠不足是個無可否認的事實
          </ReadMore>
          <p className='py-4'>
          ...
          <p className='py-2'>
            ...
            乃至主機架設跟伺服器部署都自己做，<span className='text-2xl font-bold'>沒錯！我全都要！</span>，每個部份要理解跟學"會"是真的需要犧牲非常大量的時間，
