    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16 font-serif text-xl'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          對於"框架"沒什麼概念，就只是直觀的把所有邏輯,視圖全部混在一起寫&emsp;<span className='text-gray-500  text-base'>(現在回頭看完全是地獄,根本就是無意間寫出的燒機測試軟體)</span>
          </p>
          <p className='py-2'>
            對於能憑一己之力能寫出"高品質&高效率&高彈性"的程式碼有非常大的憧憬，開始獨自從最後端的資料庫到後端邏輯到中繼層API到前端
            乃至主機架設跟伺服器部署都做，<h2 className='text-2xl font-bold'>沒錯！我全都要！</h2>，而每個部份要理解跟學"會"是真的需要犧牲非常大量的時間，
            若要細講基本上能講的比星期六休閒公園的婆婆媽媽們還要久，後端可以參考看起來很嚇人其實不會的 <Link href={`post/backendroadmap`}><span className='text-blue-700 font-bold cursor-pointer border-b-2 border-blue-600'>Backend Web Development Roadmap參考圖的貼文</span></Link>，後來也開始熟悉
