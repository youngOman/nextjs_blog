...
const AdjacentPostCard = ({ post, position }) => (
  <>
    ...
    {position === 'LEFT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-slate-700 left-4 rounded-full">
    ...
    {position === 'RIGHT' && (
      <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-slate-700 right-4 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white w-full ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
