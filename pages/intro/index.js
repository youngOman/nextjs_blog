...
const index = () => {
  return (
    <div>
      ...
      <aside className="hidden md:flex flex-col w-50 fixed right-0 rounded-lg top-40 h-auto p-5 bg-neutral-300 cursor-pointer align-middle text-gray-900 text-lg font-serif transition duration-500 ease hover:-translate-x-5">
